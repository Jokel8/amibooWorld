        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <form id="fieldTypeForm" method="POST" class="mb-4">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <input type="text" name="type_img" placeholder="Bild URL" 
                               class="border p-2 rounded">
                        <label>
                        ...
                        <input type="number" step="0.01" name="probability" 
            ...
            <div>
                ...
                <form id="mapGeneratorForm" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <input type="number" name="map_width" placeholder="Kartenbreite" 
                               class="border p-2 rounded" value="10">
                        <input type="number" name="map_height" placeholder="Kartenhöhe" 
                               class="border p-2 rounded" value="10">
                        <input type="number" name="max_resources" placeholder="Max Rohstoffe" 
                               class="border p-2 rounded" value="100">
